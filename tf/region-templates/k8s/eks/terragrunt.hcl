...
inputs = {
  ...
  aws_auth_roles = [
    {
      rolearn  = "arn:aws:iam::${local.aws_account_id}:role/dapp-store-dev"
      username = "dapp-store-dev-user"
    },
    {
      rolearn  = "arn:aws:iam::${local.aws_account_id}:role/metadex-dev"
      username = "metadex-dev-user"
    },
  ]
